...
var QuizService = /** @class */ (function () {
    ...
    QuizService.prototype.getAll = function () {
        return [
            { id: 'data/javascript.json', name: 'AWS' },
            { id: 'data/aspnet.json', name: 'DevOps' },
            { id: 'data/csharp.json', name: 'Python' },
        ];
    };
...
module.exports = __webpack_require__(/*! C:\Users\Wilson\Projects\ng2-quiz\src\main.ts */"./src/main.ts");
